...
public class ConverterAssistenteSocialAlterarInputEmAssistenteSocia implements  Converter <AssistenteSocialAlterarInput, AssistenteSocial>{

	@Override
	public AssistenteSocial convert(MappingContext<AssistenteSocialAlterarInput, AssistenteSocial> context) {
