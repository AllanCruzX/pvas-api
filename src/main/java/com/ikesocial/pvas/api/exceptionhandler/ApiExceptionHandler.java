...
import com.ikesocial.pvas.domain.exception.EntidadeEmUsoException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<?> handleClientErro(ClientApiException ex, WebRequest request) {
	...
	public ResponseEntity<?> handleNegocio(NegocioException ex, WebRequest request) {
	 ...
	 public ResponseEntity<?> inputValidationException(Exception ex, WebRequest request) {
